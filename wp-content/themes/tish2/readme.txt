...
Tish2 WordPress Theme, Copyright 2018 TishThemes.com
Tish2 is distributed under the terms of the GNU GPL
...
Tish2 WordPress Theme bundles the following third-party resources:
...
*
* functions.php -> final class tish2_Customize
* functions.php -> class tish2_Customize_Section_Pro
...
* Image Source: https://pixabay.com/en/iphone-iphone-6-iphone-6-plus-apple-791450/
...
Tish2 theme supports Slide Anything plugin to display Slider. Here is how to create a Slider to your home page:

1. Install and Activate the Slide Anything plugin: https://wordpress.org/plugins/slide-anything/

2. Navigate to Admin Panel -> Left Menu -> Slide Anything -> Slide Anything

3. Click on 'New Slideshow' and add Image Slide, Caption, URL, etc.

4. Save Changes

5. Copy shortcode from Right column (section ' How to Use'), i.e. [slide-anything id="2607"]
