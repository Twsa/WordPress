(function($) {
	...
	function tish2_init_loading_effects() {
	...
	$( document ).ready(function() {
		...
		if (tish2_options && tish2_options.loading_effect) {
			
			tish2_init_loading_effects();
		}
